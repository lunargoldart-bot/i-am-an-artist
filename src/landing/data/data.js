...
export const featuredArtworks = [
  { id: 1, title: 'Urban Reflections', artist: 'Chanda Mwamba', price: '$2,400', image: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=600&q=80', category: 'Painting', likes: 142 },
  { id: 2, title: 'Silent Rhythm', artist: 'Amina Diallo', price: '$1,800', image: 'https://images.unsplash.com/photo-1549490349-8643362247b5?w=600&q=80', category: 'Photography', likes: 98 },
  { id: 3, title: 'Digital Dreams', artist: 'Kofi Mensah', price: '$3,200', image: 'https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=600&q=80', category: 'Digital Art', likes: 215 },
  { id: 4, title: 'Earth\'s Embrace', artist: 'Nandi Ndlovu', price: '$5,000', image: 'https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=600&q=80', category: 'Sculpture', likes: 76 },
  { id: 5, title: 'Golden Hour', artist: 'Zahara Osei', price: '$1,200', image: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=600&q=80', category: 'Painting', likes: 189 },
  { id: 6, title: 'Ancestral Voices', artist: 'Kwame Asante', price: '$4,600', image: 'https://images.unsplash.com/photo-1517900798345-2e2f1e6f88ea?w=600&q=80', category: 'Digital Art', likes: 234 },
  { id: 7, title: 'Market Day', artist: 'Fatima Benali', price: '$900', image: 'https://images.unsplash.com/photo-1517462964-21fdcec3f25b?w=600&q=80', category: 'Photography', likes: 156 },
  { id: 8, title: 'Spirit of the Savanna', artist: 'Thabo Molefe', price: '$3,800', image: 'https://images.unsplash.com/photo-1501084817091-a4f3d1d19e07?w=600&q=80', category: 'Painting', likes: 312 },
  { id: 9, title: 'Metamorphosis', artist: 'Elena Okonkwo', price: '$2,900', image: 'https://images.unsplash.com/photo-1549887534-1541e9326642?w=600&q=80', category: 'Digital Art', likes: 88 },
  { id: 10, title: 'Cultural Threads', artist: 'Binta Camara', price: '$1,600', image: 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=600&q=80', category: 'Fashion', likes: 203 },
];

export const auctions = [
  { id: 1, title: 'The Ascension', artist: 'Maya Okafor', currentBid: '$12,400', endDate: '2026-08-05T18:00:00', image: 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=600&q=80', bids: 24 },
  { id: 2, title: 'Eternal Garden', artist: 'Jean-Pierre Kambale', currentBid: '$8,700', endDate: '2026-08-03T18:00:00', image: 'https://images.unsplash.com/photo-1561839561-b13bcfea49f3?w=600&q=80', bids: 18 },
  { id: 3, title: 'Rhythm of the Drums', artist: 'Amara Eze', currentBid: '$15,200', endDate: '2026-08-07T18:00:00', image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80', bids: 31 },
];
...
export const howItWorks = [
  ...
  { step: 2, title: 'Upload Your Artwork', description: 'Submit high-quality images of your work. Our team reviews and curates every submission for quality.' },
  { step: 3, title: 'Sell Worldwide', description: 'Reach collectors across the globe. We handle payments, shipping logistics, and customer support.' },
];

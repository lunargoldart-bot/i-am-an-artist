...
export default function SocialShareButtons({ artwork }) {
  ...
  const text = `Check out "${artwork.title}" by ${artwork.artist_name} on ZambiaArts — ZMW ${artwork.price?.toLocaleString()}`;
    ...
    <div className="flex items-center gap-3">
      ...
      <a href={shareLinks.whatsapp} target="_blank" rel="noopener noreferrer">
        <Button
          variant="outline"
          size="icon"
          className="h-11 w-11 border-border hover:border-green-500 hover:bg-green-500/10"
      ...
      <Button
        variant="outline"
        size="icon"
        className="h-11 w-11 border-border hover:border-pink-500 hover:bg-pink-500/10"

    ...
    <div className="flex items-center gap-2">
      ...
      <a href={shareLinks.whatsapp} target="_blank" rel="noopener noreferrer">
        <Button
          variant="outline"
          size="icon"
          className="h-8 w-8 border-border hover:border-green-500 hover:bg-green-500/10"
      ...
      <Button
        variant="outline"
        size="icon"
        className="h-8 w-8 border-border hover:border-pink-500 hover:bg-pink-500/10"

...
export default function CategoryGallery() {
  return (
    <section className="relative py-16 px-4 sm:px-6 bg-background overflow-hidden">
      <div className="absolute inset-0 opacity-30" style={{backgroundImage: "url('https://media.base44.com/images/public/69fc831faa42f7d02c44d368/bd040c8d8_generated_image.png')"}} />

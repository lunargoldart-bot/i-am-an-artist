...
export default function ZambianChangemakers() {
  return (
    <section className="relative bg-background border-b border-primary/20 py-16 px-4 sm:px-6 overflow-hidden">
      <div className="absolute inset-0 opacity-10" style={{backgroundImage: "url('https://media.base44.com/images/public/69fc831faa42f7d02c44d368/3eb28bae6_generated_image.png')"}} />

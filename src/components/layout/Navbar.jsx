            ...
            {user ? (
              <>
                ...
                <Button
                  ...
                  onClick={() => firebaseService.auth.logout('/')}
                >
                  Sign Out
                </Button>
              </>
                ...
                <Button
                  size="sm"
                  className="gold-gradient text-background font-semibold hover:opacity-90"
                  onClick={() => firebaseService.auth.redirectToLogin()}
                >
                  Join Gallery
                </Button>
            )}
      ...
      {open && (
        <div className="md:hidden bg-card border-t border-border px-4 py-4 space-y-3">
          ...
          <div className="pt-2 border-t border-border space-y-2">
            ...
            {user ? (
                  <Button size="sm" className="gold-gradient text-background w-full" onClick={() => firebaseService.auth.logout('/')}>
                    Sign Out
                  </Button>
                ) : (
                  <Button size="sm" className="gold-gradient text-background w-full" onClick={() => firebaseService.auth.redirectToLogin()}>
                    Join Gallery
                  </Button>
                )}
          </div>

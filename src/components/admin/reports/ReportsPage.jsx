...
export default function ReportsPage() {
  ...
  const columns = [
    ...
    { key: 'user_email', label: 'Reported By', render: (r) => r.user_email || r.reporter_email || '—' },
  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable columns={columns} data={grievances} searchKeys={[(r) => r.title, (r) => r.user_email, (r) => r.type]} searchPlaceholder="Search reports…" exportName="reports" pageSize={12} />
      ...
      <div className="rounded-xl border border-border bg-card p-5">
        ...
        <p className="text-sm text-muted-foreground">
          Use the export controls on any section’s table to download CSV, PDF or JSON. For scheduled or custom reporting, a dedicated analytics function can be configured in System → API &amp; Integrations.
        </p>
      </div>
    </div>
  );

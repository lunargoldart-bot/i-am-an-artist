...
import { CheckCircle, Clock, XCircle, AlertCircle, Shield, Phone, CreditCard, Briefcase } from "lucide-react";
...
export default function VerificationStatus({ onVerify }) {
  const { data: verification, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const verifications = await base44.entities.UserVerification.filter({ 

...
export default function Artists() {
  ...
  useEffect(() => {
    ArtistService.list('-createdAt', 100)
      .then(setArtists)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search artists..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 bg-card border-border" />
          </div>
